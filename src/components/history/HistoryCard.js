        ...
        <div key={this.props.singleShot.id} className="history-card">
          <div className="card-body-history">
            ...
            <div className="card-title-history">
              <p>
                <strong>Date:</strong> {this.props.singleShot.date}
              </p>
              <p>
                <strong>Shot Area: </strong>
                {this.props.singleShot.shotArea.nameOfArea}
              </p>
              <p>
                <strong>Shot Site:</strong> {this.props.singleShot.shotSiteId}
              </p>
              <p>
                <strong>Medication:</strong> {this.props.singleShot.medication}
              </p>
              <p>
                <strong>Time:</strong> {this.props.singleShot.time}
              </p>
              <p>
                <strong>Notes:</strong> {this.props.singleShot.notes}
              </p>
              {/* <Button
              type="button"
            ...
            >
              ...
              <EditShot
                ...
                shotSites={this.props.shotSites}
